<?php if ( bp_has_forum_topics( bp_ajax_querystring( 'forums' ) ) ) : ?>
	...
	<div class="pagination group-forum">
	...
	<table class="forum">
		...
		<tr>
			...
			<td class="td-freshness">
				<em><?php bp_the_topic_time_since_last_post() ?></em>
			</td>
...
<?php else: ?>
	...
	<div id="message">
		<p class="woo-sc-box note"><?php _e( 'Sorry, there were no forum topics found.', 'buddypress' ) ?></p>
	</div>
