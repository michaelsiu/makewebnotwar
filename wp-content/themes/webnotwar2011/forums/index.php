...
<div id="bp">
				...
				<form action="" method="post" id="forums-search-form" class="dir-form">
					...
					<div class="dir-header">
						<h3><?php _e( 'Group Forums Directory', 'buddypress' ) ?></h3>
						...
						<div id="forums-dir-search" class="dir-search">
							<span><?php _e('Search the forums:','buddypress'); ?></span>
						...
						<?php if ( is_user_logged_in() ) : ?>
							...
							<?php if ( bp_has_groups( 'user_id=' . bp_loggedin_user_id() . '&type=alphabetical&max=100&per_page=100' ) ) : ?>
								...
								<form action="" method="post" id="forum-topic-form" class="standard-form">
									...
									<div class="submit">
										<input class="button" type="submit" name="submit_topic" id="submit" value="<?php _e( 'Post Topic', 'buddypress' ) ?>" />
										<input class="button" type="button" name="submit_topic_cancel" id="submit_topic_cancel" value="<?php _e( 'Cancel', 'buddypress' ) ?>" />
									</div>
				...
				<form action="" method="post" id="forums-directory-form" class="dir-form">
					...
					<div class="item-list-tabs">
						<ul>
							<li class="selected" id="forums-all"><a class="tabFilter" href="<?php bp_root_domain() ?>"><?php printf( __( '<span>All Topics</span><strong>(%s)</strong>', 'buddypress' ), bp_get_forum_topic_count() ) ?></a></li>
		
							<?php if ( is_user_logged_in() && bp_get_forum_topic_count_for_user( bp_loggedin_user_id() ) ) : ?>
								<li id="forums-personal"><a class="tabFilter" href="<?php echo bp_loggedin_user_domain() . BP_GROUPS_SLUG . '/' ?>"><?php printf( __( '<span>My Topics</span><strong>(%s)</strong>', 'buddypress' ), bp_get_forum_topic_count_for_user( bp_loggedin_user_id() ) ) ?></a></li>
							<?php endif; ?>
