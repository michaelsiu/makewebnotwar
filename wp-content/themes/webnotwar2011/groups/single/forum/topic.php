	...
	<form action="<?php bp_forum_topic_action() ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div id="topic-meta">
			...
			<div class="back-buttons">
				...
				<a class="button" href="<?php bp_forum_directory_permalink() ?>/"><?php _e( 'Group Forum Directory', 'buddypress') ?></a>
			</div>
				...
				<li id="post-<?php bp_the_topic_post_id() ?>">
					<div class="poster-meta">
						<a href="<?php bp_the_topic_post_poster_link() ?>">
							<?php bp_the_topic_post_poster_avatar( 'width=32&height=32' ) ?>
						</a>
		...
		<div class="pagination no-ajax bottom">
			...
			<?php if ( bp_get_the_topic_is_last_page() ) : ?>
				...
				<?php if ( bp_get_the_topic_is_topic_open() ) : ?>
					...
					<div id="post-topic-reply">
						...
						<div class="submit">
							<input class="button" type="submit" name="submit_reply" id="submit" value="<?php _e( 'Post Reply', 'buddypress' ) ?>" />
						</div>
				...
				<?php else : ?>
					...
					<div id="message">
						<p class="woo-sc-box note"><?php _e( 'This topic is closed, replies are no longer accepted.', 'buddypress' ) ?></p>
					</div>
...
<?php else: ?>
	...
	<div id="message">
		<p class="woo-sc-box note"><?php _e( 'There are no posts for this topic.', 'buddypress' ) ?></p>
	</div>
