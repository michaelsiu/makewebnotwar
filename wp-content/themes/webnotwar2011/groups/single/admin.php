...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<p class="submit">
		<input type="submit" class="button" value="<?php _e( 'Save Changes', 'buddypress' ) ?> &rarr;" id="save" name="save" />
	</p>
...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php _e( 'Save Changes', 'buddypress' ) ?> &rarr;" id="save" name="save" /></p>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
		...
		<div class="group-avatar">
			...
			<?php if ( bp_get_group_has_avatar() ) : ?>
				<p class="delete"><?php _e( "If you'd like to remove the existing avatar but not upload a new one, please use the delete avatar button.", 'buddypress' ) ?></p>
	...
	<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
		...
		<input type="submit" class="button" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ) ?>" />
...
<?php if ( bp_is_group_admin_screen( 'membership-requests' ) ) : ?>
	...
	<?php else: ?>
		...
		<div id="message">
			<p class="woo-sc-box note"><?php _e( 'There are no pending membership requests.', 'buddypress' ); ?></p>
		</div>
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<div id="message">
		<p class="woo-sc-box note delete-group"><?php _e( 'WARNING: Deleting this group will completely remove ALL content associated with it. There is no way back, please be careful with this option.', 'buddypress' ); ?></p>
	</div>
	...
	<div class="submit">
		<input type="submit" class="button" disabled="disabled" value="<?php _e( 'Delete Group', 'buddypress' ) ?> &rarr;" id="delete-group-button" name="delete-group-button" />
	</div>
