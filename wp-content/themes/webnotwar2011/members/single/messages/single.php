		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<a class="name" href="<?php bp_the_thread_message_sender_link() ?>" title="<?php bp_the_thread_message_sender_name() ?>"><?php bp_the_thread_message_sender_name() ?></a>
		...
		<form id="send-reply" action="<?php bp_messages_form_action() ?>" method="post" class="standard-form">
			...
			<div class="message-box">
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php _e( 'Send Reply', 'buddypress' ) ?> &rarr;" id="send_reply_button" class="button"/>
