<form action="<?php bp_activity_post_form_action() ?>" method="post" id="whats-new-form" name="whats-new-form">
	...
	<?php if ( isset( $_GET['r'] ) ) : ?>
		<div id="message">
			<p class="woo-sc-box note"><?php printf( __( 'You are mentioning %s in a new update, this user will be sent a notification of your message.', 'buddypress' ), bp_get_mentioned_user_display_name( $_GET['r'] ) ) ?></p>
		</div>
	<?php endif; ?>
	...
	<div id="whats-new-content">
		...
		<div id="whats-new-options">
			<div id="whats-new-submit">
				...
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" class="button" value="<?php _e( 'Post Update', 'buddypress' ) ?>" />
			</div>
