...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p class="new-avatar"><?php _e( 'Your avatar will be used on your profile and throughout the site. If there is a <a href="http://gravatar.com">Gravatar</a> associated with your account email we will use that, or you can upload an image from your computer.', 'buddypress') ?></p>

	<form action="" method="post" id="avatar-upload-form" enctype="multipart/form-data">

		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>

			<p><?php _e( 'Browse to select a JPG, GIF or PNG format photo from your computer and then click \'Upload Image\' to proceed.', 'buddypress' ) ?></p>
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<h4><?php _e( 'Crop Your New Avatar', 'buddypress' ) ?></h4>
			...
			<input type="submit" name="avatar-crop-submit" class="button" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ) ?>" />
