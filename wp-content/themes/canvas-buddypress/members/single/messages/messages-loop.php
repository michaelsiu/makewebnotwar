		...
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			...
			<tr id="m-<?php bp_message_thread_id() ?>"<?php if ( bp_message_thread_has_unread() ) : ?> class="unread"<?php else: ?> class="read"<?php endif; ?>>
				...
				<td width="50%" class="thread-info">
					<p><a href="<?php bp_message_thread_view_link() ?>" class="message-title" title="<?php _e( "View Message", "buddypress" ); ?>"><?php bp_message_thread_subject() ?></a></p>
				...
				<td width="13%" class="thread-options">
					...
					<a class="delete" href="<?php bp_message_thread_delete_link() ?>" title="<?php _e( "Delete Message", "buddypress" ); ?>">x</a> &nbsp;
				</td>
			</tr>
...
<?php else: ?>
	...
	<div id="message">
		<p class="woo-sc-box note"><?php _e( 'Sorry, no messages were found.', 'buddypress' ); ?></p>
	</div>
